...
const AUser = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("slacktosurplus.up.railway.app/admin/users");
  ...
  const handleSave = async () => {
    try {
      await axios.put(`slacktosurplus.up.railway.app/admin/user/${editingUserId}`, formData);
      fetchUsers();
      handleCancelEdit();
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`slacktosurplus.up.railway.app/admin/user/${id}`);
      fetchUsers();
    } catch (error) {
