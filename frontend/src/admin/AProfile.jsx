...
const AProfile = () => {
  ...
  const fetchProfiles = async () => {
    try {
      const response = await axios.get("https://slacktosurplus.up.railway.app/admin/profiles");
  ...
  const handleSave = async () => {
    try {
      if (editingId) {
        // Update profile
        await axios.put(`https://slacktosurplus.up.railway.app/admin/profile/${editingId}`, formData);
      } else {
        // Add new profile
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://slacktosurplus.up.railway.app/admin/profile/${id}`);
      fetchProfiles();
    } catch (error) {
