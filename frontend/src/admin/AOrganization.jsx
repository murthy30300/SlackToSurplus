...
const AOrganization = () => {
  ...
  const fetchOrganizations = async () => {
    try {
      setLoading(true);
      const response = await axios.get("https://slacktosurplus.up.railway.app/admin/organizations");
  ...
  const addOrganization = async () => {
    try {
      ...
      await axios.post("https://slacktosurplus.up.railway.app/admin/organization", formData);
  ...
  const updateOrganization = async () => {
    try {
      await axios.put(
        `https://slacktosurplus.up.railway.app/admin/organization/${editId}`,
        formData
      );
  ...
  const deleteOrganization = async (id) => {
    ...
    try {
      await axios.delete(`https://slacktosurplus.up.railway.app/admin/organization/${id}`);
